<template>
  <div>
    ...
    <a-row :gutter="[16, 16]" :wrap="true">
      <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8" v-for="(item, index) in pieChartConfig" :key="index">
        <BasePieChart :chart-title="item.title" :unit="item.unit" :series-data="formatData(productionStore.monthlyProduction.data, item.key)
...
const pieChartConfig = [
  ...
  { key: 'production_time', title: 'Production Time', unit: 'Min' },
]
